...
delay_us(cyg_int32 usecs)
{
...
#ifdef CYGPKG_KERNEL
    {
        ...
        do {
            ...
            slice = (cyg_int32)usec_ticks % (CYGNUM_KERNEL_COUNTERS_RTC_PERIOD / 2);
    
            HAL_CLOCK_READ((cyg_uint32*)&start);
            do {
                HAL_CLOCK_READ((cyg_uint32*)&elapsed);
...
//    goto *HAL_PLATFORM_RESET_ENTRY;//clyu 
...
//----------------------------------
// Comm controls
#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_CLAIM_COMMS//defined
...
#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_INIT_WHOLE_TABLE//defined
    {
        int i;
...
#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_CLAIM_RESET //defined
    CYGACC_CALL_IF_RESET_SET(reset);
    CYGACC_CALL_IF_KILL_VECTOR_SET(kill_by_reset);
#endif
#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_CLAIM_DELAY_US//defined
    CYGACC_CALL_IF_DELAY_US_SET(delay_us);
#endif

#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_CLAIM_CACHE//defined
    // Cache functions
...
#ifdef CYGSEM_HAL_VIRTUAL_VECTOR_CLAIM_DATA//defined
