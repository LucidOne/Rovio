...
CYGBLD_ATTRIB_WEAK void hal_spurious_IRQ(HAL_SavedRegisters *regs) ;
void
...
extern pfunc  __CTOR_LIST__[];//C$$pi_ctorvec$$Base[];
extern pfunc __CTOR_END__[];//C$$pi_ctorvec$$Limit[];
extern int __cpp_initialise(void);
//C$$pi_dtorvec$$Limit
