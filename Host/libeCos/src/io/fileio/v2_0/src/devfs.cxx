...
struct cyg_fstab_entry dev_fste ={ "devfs", 0,
...
#pragma arm section rwdata = "mtab"
struct cyg_mtab_entry dev_mte=
{
	"/dev",
    "devfs",
    "",
...
static int dev_fo_ioctl     (struct CYG_FILE_TAG *fp, CYG_ADDRWORD com,
                             CYG_ADDRWORD data)
{
	return cyg_io_ioctl((cyg_io_handle_t)fp->f_data, com, (const void *)data);
}
