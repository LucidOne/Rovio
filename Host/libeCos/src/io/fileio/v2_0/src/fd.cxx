...
//extern "C" int fatall_fo_close(cyg_file *fp);

static int fp_ucount_dec( cyg_file *fp )
{
    int error = 0;
    volatile bool real_close = false;
    if(fp == NULL)
    	return -1;
...
static cyg_file *fd_check_close( int fd )
{
    cyg_file *fp;
    volatile bool real_close = false;
