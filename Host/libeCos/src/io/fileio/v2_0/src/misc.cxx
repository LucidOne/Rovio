...
cyg_fstab_entry *fstab = (cyg_fstab_entry *)&Image$$ECOS_FILE$$Base;

// end of filesystem table, set in linker script.
__externC cyg_fstab_entry *fstab_end;
//CYG_HAL_TABLE_END( fstab_end, fstab );
cyg_fstab_entry *fstab_end = (cyg_fstab_entry *)&Image$$ECOS_FILE$$Limit;
...
cyg_mtab_entry *mtab = (cyg_mtab_entry *)&Image$$ECOS_MTAB$$Base;
#pragma arm section zidata = "mtab"
// Extra entries at end of mtab for dynamic mount points.
cyg_mtab_entry mtab_extra[CYGNUM_FILEIO_MTAB_EXTRA] = { { NULL } };
#pragma arm section zidata
// End of mount table, set in the linker script.
__externC cyg_mtab_entry *mtab_end;
//CYG_HAL_TABLE_END( mtab_end, mtab );
cyg_mtab_entry *mtab_end = (cyg_mtab_entry *)&Image$$ECOS_MTAB$$ZI$$Limit;
...
static void cyg_mtab_init()
{
    __align(4) cyg_mtab_entry *m;
    
    for( m = &mtab[0]; m != mtab_end; m++ )
    {
        __align(4) const char *fsname = m->fsname;
        __align(4) cyg_fstab_entry *f;
