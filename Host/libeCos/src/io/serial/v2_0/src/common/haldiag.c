...
static serial_channel haldiag_channel0 = {
    ...
    &(_no_data),
    CYG_SERIAL_INFO_INIT(CYG_SERIAL_BAUD_DEFAULT, CYG_SERIAL_STOP_DEFAULT, CYG_SERIAL_PARITY_DEFAULT, CYG_SERIAL_WORD_LENGTH_DEFAULT, CYG_SERIAL_FLAGS_DEFAULT),
};
#if 0
static SERIAL_CHANNEL( haldiag_channel0,
               haldiag_funs, 
...
DEVTAB_ENTRY(haldiag_io0, 
             ...
             &haldiag_channel0);
#else
cyg_devtab_entry_t haldiag_io0= {
   "/dev/haldiag",
   0,
   &cyg_io_serial_devio,
   haldiag_init,
