...
{
#if !CYG_NO_THREADID    
//diag_printf("simple.cxx write_thread_id Cyg_Thread\n");
...
extern "C"
{
extern unsigned long Image$$RAM_T$$Base;
extern unsigned long Image$$RAM_T$$Limit;

unsigned long stext_addr = (unsigned long)Image$$RAM_T$$Base;
unsigned long etext_addr = (unsigned long)Image$$RAM_T$$Limit;
};
