...
//diag_printf("post_dsr in,dsr_count=%d\n",dsr_count);
    HAL_DISABLE_INTERRUPTS(old_intr);
    ...
    if( dsr_count++ == 0 )
    {
        ...
        dsr_list[cpu] = this;
        dsr_list[cpu]->next_dsr = next_dsr;//clyu 20070711
    }
...
//diag_printf("intr.cxx interrupt_end,isr_ret=%d,intr=%x\n",isr_ret,intr);
