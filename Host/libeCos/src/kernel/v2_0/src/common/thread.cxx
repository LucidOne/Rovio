...
#endif
{
    ...
    init_context(this);
//diag_printf("&list_next = %x,list_next=%x\n",&list_next,list_next);
    CYG_REPORT_RETURN();
}
...
Cyg_Thread::sleep()
{
	...
	HAL_DISABLE_INTERRUPTS(old);//clyu add 12/23/2004
    ...
    HAL_RESTORE_INTERRUPTS(old);//clyu add 12/23/2004
...
Cyg_Thread::delay( cyg_tick_count delay)
{
    ...
    clear_timer();
//diag_printf("clear_timer return wake_reason=%d\n",wake_reason);
