...
//diag_printf("mutex lock = %x\n",__builtin_return_address(0));
    ...
    while( locked && result )
    {
       ...
       // diag_printf("locked wait\n");
        self->set_sleep_reason( Cyg_Thread::WAIT );
        
        self->sleep();
//        diag_printf("mutex.cxx sleep return call enqueue\n");
        queue.enqueue( self );
...
#endif
//diag_printf("wakeup %x\n", thread);
        thread->set_wake_reason( Cyg_Thread::DONE );
        
        thread->wake();
       
        Cyg_Scheduler::scheduler.set_need_reschedule();//clyu
    ...
    //diag_printf("owner->priority = %d\n",owner->get_current_priority());
