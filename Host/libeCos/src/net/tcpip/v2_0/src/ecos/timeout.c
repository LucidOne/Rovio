...
#define STACK_SIZE (8192)//CYGNUM_HAL_STACK_SIZE_TYPICAL//clyu 20070615
...
alarm_thread(cyg_addrword_t param)
{
    ...
    while ( 1 ) {
        ...
        cyg_splx(spl/*, __FILE__, __LINE__*/);
    }
}
...
timeout(timeout_fun *fun, void *arg, cyg_int32 delta)
{
    ...
    timeout_entry *e;
    cyg_uint32 stamp;
//diag_printf("timeout %x  %d\n",__builtin_return_address(0),delta);
