...
static struct _file_info file_list[5] = {
    { "uu", (unsigned char *)_uu_data, sizeof(_uu_data)-1, sizeof(_uu_data)-1},
    { _name0, (unsigned char *)_f0_data, 0, sizeof(_f0_data)}, // Empty file
    { _name1, (unsigned char *)_f1_data, 0, sizeof(_f1_data)}, // Empty file
    { _name2, (unsigned char *)_f2_data, 0, sizeof(_f2_data)}, // Empty file
    { 0, 0, 0}  // End of list
};
