...
extern void bluez_dump(char *pref, cyg_uint8 *buf, int count);

#define BT_INFO(fmt, arg...) diag_printf(fmt "\n" , ## arg)
#define BT_DBG(fmt, arg...)  diag_printf("%s: " fmt "\n" , __func__ , ## arg)
#define BT_ERR(fmt, arg...)  diag_printf("%s: " fmt "\n" , __func__ , ## arg)
...
#define bluez_sk(pi) ((struct sock *) \
	((char *)pi - (unsigned long)(&((struct sock *)0)->protinfo)))
