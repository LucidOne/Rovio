...
#define L2CAP_CONN_TIMEOUT 	(HZ * 60)

/* L2CAP socket address */
struct sockaddr_l2 {
	u_int8_t    l2_len;		/* total length */
...
struct l2cap_qos {
	cyg_uint16 service_type;
	cyg_uint32 token_rate;
	cyg_uint32 token_bucket_size;
...
struct l2cap_pinfo {
	...
	cyg_uint8		conf_state;
	cyg_uint8		conf_retry;
	cyg_uint16		conf_mtu;
