...
// Description: __inline functions for the scheduler classes. These are
//              not defined in the header so that we have the option
//              of making them non-__inline.
// Usage:
...
__inline void Cyg_Scheduler::lock()
{
...
__inline void Cyg_Scheduler::unlock()
{
    // This is an __inline wrapper for the real scheduler unlock function in
...
__inline void Cyg_Scheduler::reschedule()
{
...
__inline void Cyg_Scheduler:: unlock_reschedule()
{
...
__inline void Cyg_Scheduler::unlock_simple()
{
...
__inline void Cyg_SchedThread::remove()
{
    if( queue != NULL )
    {
