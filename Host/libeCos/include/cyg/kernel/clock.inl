...
// or __inline functions from this file, or you compile this file and link it
...
// Description: Define __inline functions for counter, clock and alarm
//              classes.
...
__inline cyg_tick_count Cyg_Counter::current_value()
{
    return counter;
}

__inline cyg_uint32 Cyg_Counter::current_value_lo()
{
    return counter&0xFFFFFFFF;
}

__inline cyg_uint32 Cyg_Counter::current_value_hi()
{
    return (counter>>32)&0xFFFFFFFF;
}

// Set the counter's current value
__inline void Cyg_Counter::set_value( cyg_tick_count new_value)
{
    counter = new_value;
}
...
__inline Cyg_Clock::cyg_resolution Cyg_Clock::get_resolution()
{
    return resolution;
}

// Set new resolution
__inline void Cyg_Clock::set_resolution(                
...
__inline cyg_tick_count Cyg_Clock::convert(
...
__inline void Cyg_Alarm::disable()
{
