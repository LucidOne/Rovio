...
__inline void Cyg_HardwareThread::check_stack(void)
{
...
__inline cyg_uint32 Cyg_HardwareThread::measure_stack_usage(void)
{
#ifdef CYGFUN_KERNEL_THREADS_STACK_LIMIT
...
__inline void Cyg_HardwareThread::attach_stack(CYG_ADDRESS s_base, cyg_uint32 s_size)
{
...
__inline Cyg_HardwareThread::Cyg_HardwareThread(
...
__inline HAL_SavedRegisters *Cyg_HardwareThread::get_saved_context()
{
...
__inline void Cyg_HardwareThread::set_saved_context(HAL_SavedRegisters *ctx)
{
    saved_context = ctx;
}
...
__inline cyg_uint16 Cyg_Thread::get_unique_id()
{
    return unique_id;
}
...
__inline void Cyg_HardwareThread::init_context(Cyg_Thread *thread)
{
...
__inline void Cyg_HardwareThread::switch_context(Cyg_HardwareThread *next)
{
...
__inline void Cyg_HardwareThread::set_entry_data( CYG_ADDRWORD data )
{
    entry_data = data;
}

__inline CYG_ADDRWORD Cyg_HardwareThread::get_entry_data()
{
    return entry_data;
}
...
__inline void *Cyg_HardwareThread::increment_stack_limit( cyg_ucount32 size )
{
...
__inline Cyg_Thread *Cyg_Thread::self()
{
...
__inline void Cyg_Thread::yield()
{
...
__inline cyg_priority Cyg_Thread::get_priority()
{
...
__inline cyg_priority Cyg_Thread::get_current_priority()
{
    return priority;
}
...
__inline void Cyg_Thread::set_sleep_reason( cyg_reason reason)
{
...
__inline Cyg_Thread::cyg_reason Cyg_Thread::get_sleep_reason()
{
    return sleep_reason;
}
...
__inline void Cyg_Thread::set_wake_reason( cyg_reason reason )
{
    sleep_reason = NONE;
    wake_reason = reason;
}
...
__inline Cyg_Thread::cyg_reason Cyg_Thread::get_wake_reason()
{
    return wake_reason;
}
...
__inline void Cyg_Thread::set_timer(
...
__inline void Cyg_Thread::clear_timer()
{
#ifdef CYGFUN_KERNEL_THREADS_TIMER
    self()->timer.disable();
#endif
...
__inline CYG_ADDRWORD Cyg_Thread::get_data( Cyg_Thread::cyg_data_index index )
{
...
__inline CYG_ADDRWORD *Cyg_Thread::get_data_ptr( Cyg_Thread::cyg_data_index index )
{
    CYG_ASSERT( index < CYGNUM_KERNEL_THREADS_DATA_MAX,
                "Per thread data index out of bounds");
    CYG_ASSERT( (thread_data_map & (1<<index)) == 0,
...
__inline void Cyg_Thread::set_data( Cyg_Thread::cyg_data_index index,
                                  CYG_ADDRWORD data )
{
    CYG_ASSERT( index < CYGNUM_KERNEL_THREADS_DATA_MAX,
                "Per thread data index out of bounds");
...
__inline char *Cyg_Thread::get_name()
{
    return name;
}
...
__inline Cyg_Thread *Cyg_Thread::get_list_head()
{
    return thread_list?thread_list->list_next:0;
}
    
__inline Cyg_Thread *Cyg_Thread::get_list_next()
{
...
__inline void Cyg_Thread::register_exception(
...
__inline void Cyg_Thread::deregister_exception(
    cyg_code                exception_number        // exception number
    )
{
...
__inline Cyg_ThreadTimer::Cyg_ThreadTimer(
    Cyg_Thread  *th
    )
...
__inline void Cyg_ThreadQueue::enqueue(Cyg_Thread *thread)
{
...
__inline Cyg_Thread *Cyg_ThreadQueue::highpri()
{
...
__inline Cyg_Thread *Cyg_ThreadQueue::dequeue()
{
...
__inline void Cyg_ThreadQueue::remove(Cyg_Thread *thread)
{
...
__inline cyg_bool Cyg_ThreadQueue::empty()
{
