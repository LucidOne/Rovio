...
__inline Cyg_ErrNo cyg_stdio_open( const char *filename,
...
__inline Cyg_ErrNo cyg_stdio_close( cyg_stdio_handle_t dev )
{
    if( close( dev ) != ENOERR )
        return errno;
    return ENOERR;
...
__inline Cyg_ErrNo cyg_stdio_read( cyg_stdio_handle_t dev,
...
__inline Cyg_ErrNo cyg_stdio_write( cyg_stdio_handle_t dev,
...
__inline Cyg_ErrNo cyg_stdio_lseek( cyg_stdio_handle_t dev,
...
__inline Cyg_ErrNo cyg_stdio_flush( cyg_stdio_handle_t dev )
{
    int err = fsync( dev );
...
__inline cyg_bool cyg_stdio_interactive( cyg_stdio_handle_t dev )
{
    struct stat buf;
    int err;
...
__inline cyg_uint32 cyg_stdio_lseek( cyg_stdio_handle_t dev,
