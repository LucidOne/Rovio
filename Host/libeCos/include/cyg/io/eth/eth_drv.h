...
struct eth_drv_sc {
    ...
    struct iw_statistics*   (*get_wireless_stats)(struct eth_drv_sc *sc);
    int                  state;
    struct arpcom        sc_arpcom; /* ethernet common */
};

#define ETH_DRV_SC(sc,priv,name,start,stop,control,can_send,send,recv,deliver,poll,int_vector, wireless_handlers, iw_statistics) \
...
struct eth_drv_sc sc = {&sc##_funs, priv, name, wireless_handlers, iw_statistics}
