...
#define BLOCK_DEVIO_TABLE(_l,_bwrite,_bread,_select,_get_config,_set_config,_ioctl)    \
cyg_devio_table_t _l = {                                        \
	cyg_devio_cwrite,                                           \
    cyg_devio_cread,                                            \
    _bwrite,                                                    \
...
#define DEVIO_TABLE(_l,_write,_read,_select,_get_config,_set_config,_ioctl) \
        CHAR_DEVIO_TABLE(_l,_write,_read,_select,_get_config,_set_config,_ioctl)
...
extern cyg_devtab_entry_t *__PIPEDEVTAB__, *__PIPEDEVTAB_END__;
