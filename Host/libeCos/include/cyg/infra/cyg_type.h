...
#define CYG_REFERENCE_OBJECT(__object__)                                 \
     CYG_MACRO_START                                                     \
     static void *__cygvar_discard_me__ =       \
                                                          &(__object__); \
     CYG_MACRO_END
...
#  define CYGBLD_ATTRIB_ALIGN(__align__) __align(__align__)//__attribute__((aligned(__align__)))
# endif
...
# define CYGBLD_ATTRIB_WEAK  __weak/* !!!-- Attribute weak not defined --!!! */
...
extern unsigned int Image$$RAM_B$$ZI$$Base,Image$$RAM_B$$ZI$$Limit;
extern unsigned int Image$$PIPE_ECOS_DEV$$Base,Image$$PIPE_ECOS_DEV$$Limit;
extern unsigned int Image$$ECOS_DEV$$Base,Image$$ECOS_DEV$$Limit;
extern unsigned int Image$$ECOS_FILE$$Base,Image$$ECOS_FILE$$Limit;
extern unsigned int Image$$ECOS_MTAB$$Base,Image$$ECOS_MTAB$$Limit,Image$$ECOS_MTAB$$ZI$$Limit;
extern unsigned int Image$$ECOS_NETDEV$$Base,Image$$ECOS_NETDEV$$Limit;
extern unsigned int Image$$ECOS_NSTAB$$Base,Image$$ECOS_NSTAB$$Limit;
