 ...
 *
 * DESCRIPTION
 *     This file contains the register map and bit definition of W56964
 *
 * HISTORY
...
//#define MW_ERROR_REGRW				(-1)	/* error of register R/W */
//#define MW_ERROR_ARGUMENT			(-2)	/* error of arguments */
//#define MW_ERROR_RESET				(-3)	/* error of reset */
//#define MW_ERROR_POWERDOWN		(-4)	/* error of power down */

// for W56964 12.288MHz CLKI
#define	W56964_CLKI			12288000
#define	W56964_PLL_ADJUST_N	12
#define	W56964_PLL_ADJUST_M	56
//for W56940/W56964 
#define PLLOUT					(W56964_CLKI * (W56964_PLL_ADJUST_M + 4) / (float)W56964_PLL_ADJUST_N)
#define W56964_SYSTEM_CLOCK		(PLLOUT / 8.0f)
#define	W56964_NEW_SYSTEM_CLOCK	(PLLOUT / 6.0f)
#define	TCLK					(PLLOUT / 2)
#define	ALLOWED_SAMPLE_RATE		(TCLK / 1280)


#define	SPK_VOL_REG_VDS			0

#define	MELODY_BUFFER_NUM		2
#define	MELODY_FIFO_SIZE		256
#define	MELODY_FIFO_FILL_SIZE	128
#define	SPEECH_FIFO_SIZE		256
#define	SPEECH_FIFO_FILL_SIZE	192

// set headphone to be mono or stereo
// 0: stereo
// 1: mono
