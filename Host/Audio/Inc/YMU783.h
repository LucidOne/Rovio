...
/*
        7       6       5       4       3       2       1       0
	+-------+-------+-------+-------+-------+-------+-------+-------+
	|  RST  |R_FIFO1|R_FIFO0|R_SEQ#1|R_SEQ#0|        B A N K        |
	+-------+-------+-------+-------+-------+-------+-------+-------+
*/
#define	MAB_RST							(0x80)
...
/*
        7       6       5       4       3       2       1       0
	+-------+-------+-------+-------+-------+-------+-------+-------+
	|  "0"  |  "0"  |  DP5  |  D4   |   0   |   DP2 |   DP1 |   DP0 |
	+-------+-------+-------+-------+-------+-------+-------+-------+
*/
#define MAB_PWM_DP5						(1<<5)
#define MAB_PWM_DP4						(1<<4)
...
/*
        7       6       5       4       3       2       1       0
	+-------+-------+-------+-------+-------+-------+-------+-------+
	| PLLPD |  "0"  |  "0"  |  AP4  |  AP3  |  AP2  |  AP1  |  AP0  |
	+-------+-------+-------+-------+-------+-------+-------+-------+
*/
#define MAB_PWM_PLLPD					(0x80)
#define MAB_PWM_AP4						(1<<4)
...
/*
        7          6       5       4       3         2        1         0
	+----------+-------+-------+-------+---------+---------+--------+----------+
	|  "0"     |  "0"  |  "0"  |  "0"  |TX_EXMIX |TX_RXMIX | "0"    |TX_DACMIX |
	+----------+-------+-------+-------+---------+---------+--------+----------+
*/
#define	MAB_MIXER_TX_EXMIX							(1<<3)
#define	MAB_MIXER_TX_RXMIX							(1<<2)
#define	MAB_MIXER_TX_DAMIX							(1)
...
/*
        7         6         5       4         3       2         1        0
	+--------+---------+--------+---------+---------+--------+--------+---------+
	|HR_EXMIX|HR_RXMIX |   "0"  |HR_DAMIX | HL_EXMIX|HL_RXMIX|  "0"   |HL_DAMIX |
	+--------+---------+--------+---------+---------+--------+----*---+---------+
*/
#define	MAB_MIXER_HR_DAMIX							(1<<4)
#define	MAB_MIXER_HL_DAMIX							(1)

#define	MAI3_SPOUT_MIXER	(26)
/*
        7         6         5       4         3         2        1        0
	+---------+---------+--------+--------+---------+---------+--------+---------+
	|SPR_EXMIX|SPR_RXMIX|   "0"  |  "0"   |SPL_EXMIX|SPL_RXMIX|  "0"   |SP_DACMIX|
	+---------+---------+--------+--------+---------+---------+----*---+---------+
*/
#define	MAB_MIXER_SP_DAMIX							(1<<1)

#define	MAI3_DA_LVOL	(29)
#define	MAI3_DA_RVOL	(30)

#define MAI3_BB		(35)
#define	MAI3_DAVOL	(36)
