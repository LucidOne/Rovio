...
#define TEST_GETSOCKNAME_SERVER_BEGIN_PORT TEST_REMOTEFUNC_SERVER_BEGIN_PORT

#define TEST_GETSOCKNAME_SERVER_NUM (MAX_THREADS/2)

#define TEST_GETSOCKNAME_MSG TEST_REMOTEFUNC_MSG
#define TEST_GETSOCKNAME_MSG_LEN TEST_REMOTEFUNC_MSG_LEN
