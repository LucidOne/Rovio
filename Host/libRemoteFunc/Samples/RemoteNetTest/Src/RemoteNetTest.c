...
__align (32) CHAR g_RemoteNet_Buf1[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf2[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf3[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf4[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf5[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf6[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
__align (32) CHAR g_RemoteNet_Buf7[MEM_ALIGN_SIZE(RNT_BUFFER_LEN)];
#pragma arm section zidata

__align (32) char thread_stack1[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack2[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack3[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack4[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack5[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack6[MEM_ALIGN_SIZE(STACK_SIZE)];
__align (32) char thread_stack7[MEM_ALIGN_SIZE(STACK_SIZE)];
static cyg_handle_t thread_handle1, thread_handle2, thread_handle3, thread_handle4, thread_handle5, thread_handle6, thread_handle7;
static cyg_thread thread1, thread2, thread3, thread4, thread5, thread6, thread7;
...
void simple_tcpserver(cyg_addrword_t pnetdata)
{
	...
	if((hp = gethostbyname("zzqing", pbuf, RNT_BUFFER_LEN)) == NULL)
	{
