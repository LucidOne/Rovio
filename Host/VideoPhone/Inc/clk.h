...
#define TURN_OFF_TIMER_CLOCK	do {outpw (REG_CLKCON, inpw (REG_CLKCON) & ~TCLK_EN);} while (0)
...
#define TURN_ON_USB_CLOCK		do {outpw (REG_CLKCON, inpw (REG_CLKCON) | USBCLK_EN); } while (0)
#define TURN_OFF_USB_CLOCK		do {outpw (REG_CLKCON, inpw (REG_CLKCON) & ~USBCLK_EN); } while (0)
#define TURN_ON_FMI_CLOCK		do {outpw (REG_CLKCON, inpw (REG_CLKCON) | FMICLK_EN); } while (0)
#define TURN_OFF_FMI_CLOCK		do {outpw (REG_CLKCON, inpw (REG_CLKCON) & ~FMICLK_EN); } while (0)
