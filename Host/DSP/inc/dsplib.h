...
/***********************************************************************************
	The definitions of Error Number of DSP library
***********************************************************************************/
#define DSP_NO_ERROR			0	/* Sensor DSP library ID */
#define DSP_I2C_READ_ERR	(DSP_ERR_ID | 0x01)	/* The handshaking with Sensor was error  */
#define DSP_NO_SENSOR_INIT	(DSP_ERR_ID | 0x02)	/* The handshaking with Sensor was error  */
...
typedef enum Video_Source_Listing
{	SENSOR_OV2630=0,
	SENSOR_OV9650,
	SENSOR_OV764x,
	SENSOR_MT9M111,
