...
#define HTTP_USERNAME_LEN 24
#define HTTP_PASSWORD_LEN 24
typedef struct {
    char	Username[HTTP_USERNAME_LEN];
    char	Passwd[HTTP_PASSWORD_LEN];
    int		Privilege;
}HTTP_PRIVILEGE_T;
...
//	int data_fd;				/* fd of data */
	...
	REQUEST_OVER_PFUN funOnRequestOver;
	void *pParamForFunRequestOver;
	...
	char *x_sessioncookie;		/* for RTSP over HTTP */
	...
	HTTP_PRIVILEGE_T httpPrivilege;
...
#define RNT_BUFFER_LEN (100*1024)
//extern CHAR g_RemoteNet_Buf[RNT_BUFFER_LEN];
extern CHAR *g_RemoteNet_Buf;
