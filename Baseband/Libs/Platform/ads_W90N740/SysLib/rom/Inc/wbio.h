...
#define W90N740_INTEGRATOR_BOARD FALSE

#if W90N740_INTEGRATOR_BOARD

/* Emulation AP board */
#define IO_BASE         0xCFF00000
...
#define outpb(port,value)     (*((UINT8 volatile *)(IO_BASE + port))=value)
#define inpb(port)            (*((UINT8 volatile *)(IO_BASE + port)))
#define outphw(port,value)    (*((UINT16 volatile *)(IO_BASE + port))=value)
#define inphw(port)           (*((UINT16 volatile *)(IO_BASE + port)))
#define outpw(port,value)     (*((UINT32 volatile *)(IO_BASE + port))=value)
#define inpw(port)            (*((UINT32 volatile *)(IO_BASE + port)))
...
{
    return (val<<24) | ((val<<16)&0xff0000) | ((val>>8)&0xff00) | (val>>24);
}
